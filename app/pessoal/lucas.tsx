...
const theme = PROFILE_THEMES.lucas;

export default function LucasScreen() {
  ...
  const { tasks, loading: tasksLoading, addTask, renameTask, toggleTask, deleteTask } = usePersonalTasks('lucas');
  const {
    reminders,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        <Text style={styles.headerName} numberOfLines={1}>Lucas</Text>
        <Text style={styles.headerSubtitle}>👋 Olá, Lucas!</Text>
      </View>

      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner} showsVerticalScrollIndicator={false}>
        <OverdueTasksBanner personId="lucas" />
        {/* Card Estatísticas */}
              ...
              {myActivities.map(activity => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => toggleCompletion(activity, dateKey, 'lucas', 'Lucas')}
                    activeOpacity={0.7}
        ...
        <View style={styles.quickLinksSection}>
          ...
          <View style={styles.linksContainer}>
            ...
            <TouchableOpacity
              style={styles.quickLink}
              onPress={() => router.push('/calendario/calendarioL')}
              activeOpacity={0.75}
              accessibilityRole="link"
            >
        ...
        <View style={styles.footerContainer}>
          <Image
            source={require('@/assets/images/formula1.png')}
