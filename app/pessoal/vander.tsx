...
const theme = PROFILE_THEMES.vander;
...
export default function VanderScreen() {
  ...
  const { tasks, loading: tasksLoading, addTask, renameTask, toggleTask, deleteTask } = usePersonalTasks('vander');
  const {
    reminders,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        <Text style={styles.headerName} numberOfLines={1}>Vander</Text>
