...
export default function VanderScreen() {
  ...
  const { reminders, addReminder, updateReminder, completeReminder, deleteReminder } = useReminders('vander');
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 15 }]}>
        <View style={styles.headerCenter}>
          <Text style={styles.headerName}>Vander</Text>
          <Text style={styles.headerSubtitle}>👋 Olá, Vander!</Text>
        </View>
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <OverdueTasksBanner personId="vander" />
        {/* Card Estatísticas */}
              ...
              {myActivities.map(activity => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => toggleCompletion(activity, dateKey, 'vander', 'Vander')}
                    activeOpacity={0.7}
                  >
        ...
        <View style={styles.quickLinksSection}>
          ...
          <View style={styles.linksContainer}>
            ...
            <TouchableOpacity
              style={styles.quickLink}
              onPress={() => router.push('/calendario/calendarioV')}
            >
        ...
        {/* Foto Reidanoite Footer */}
        <View style={styles.footerContainer}>
          <Image
            source={require('@/assets/images/reidanoite.png')}
            style={styles.reidaImage}
            resizeMode="contain"
          />
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  statDivider: {
    width: 1,
    height: 40,
    backgroundColor: 'rgba(127, 212, 193, 0.3)',
  },
  statNumber: {
    fontSize: 28,
    fontWeight: '700',
  ...
  progressBar: {
    height: 8,
    backgroundColor: 'rgba(127, 212, 193, 0.1)',
    borderRadius: 4,
    overflow: 'hidden',
    marginBottom: 8,
  },
  ...
  tableHeader: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(127, 212, 193, 0.2)',
    backgroundColor: '#0a2618',
  },
  tableHeaderText: {
    fontSize: 11,
  ...
  tableRow: {
    ...
    paddingHorizontal: 10,
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(127, 212, 193, 0.1)',
  },
  cellText: {
    fontSize: 12,
    color: '#fff',
