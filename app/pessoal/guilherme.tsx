...
const theme = PROFILE_THEMES.guilherme;
...
export default function GuilhermeScreen() {
  ...
  const { tasks, loading: tasksLoading, addTask, renameTask, toggleTask, deleteTask } = usePersonalTasks('guilherme');
  const {
    reminders,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        <Text style={styles.headerName} numberOfLines={1}>Guilherme</Text>
