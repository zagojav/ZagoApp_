...
export default function AmandaScreen() {
  ...
  const { reminders, addReminder, updateReminder, completeReminder, deleteReminder } = useReminders('amanda');
...
const styles = StyleSheet.create({
  ...
  tableHeader: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(245, 222, 179, 0.2)',
    backgroundColor: '#5A3E32',
  },
  tableHeaderText: {
    fontSize: 11,
