...
const theme = PROFILE_THEMES.amanda;
...
export default function AmandaScreen() {
  ...
  const { tasks, loading: tasksLoading, addTask, renameTask, toggleTask, deleteTask } = usePersonalTasks('amanda');
  const {
    reminders,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        <Text style={styles.headerName} numberOfLines={1}>Amanda</Text>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.quickLinksSection}>
          ...
          <View style={styles.linksContainer}>
            ...
            <TouchableOpacity
              style={styles.quickLink}
              onPress={() => router.push('/calendario/calendarioA')}
              activeOpacity={0.75}
              accessibilityRole="link"
            >
        ...
        <View style={styles.footerContainer}>
          <Image
            source={require('@/assets/images/hooty.png')}
