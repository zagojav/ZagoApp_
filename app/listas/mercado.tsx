    ...
    <View style={casa.container}>
      <View style={[casa.header, { paddingTop: insets.top + 14 }]}>
        ...
        {view === 'lista' ? (
          ...
          // Mantém o título centralizado quando o + não aparece.
      ...
      <View style={styles.viewSwitch}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          accessibilityRole="tab"
          accessibilityState={{ selected: view === 'precos' }}
        >
...
const styles = StyleSheet.create({
  /** Reserva a largura do botão "+" quando ele não é exibido, para o
   *  título continuar no centro exato da barra. */
  addBtnSpacer: { width: 40 },
  viewSwitch: { flexDirection: 'row', gap: Spacing.sm, paddingHorizontal: Spacing.xl, paddingBottom: Spacing.sm + 2 },
  viewSwitchBtn: {
    flex: 1,
  ...
  viewSwitchBtnActive: { backgroundColor: Casa.surfaceWarm },
  viewSwitchText: { fontSize: 13, fontWeight: '600', color: Casa.inkMuted },
  viewSwitchTextActive: { color: Casa.ink, fontWeight: '700' },
