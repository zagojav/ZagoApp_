...
const theme = CALENDAR_THEMES.emanuella;
...
export default function CalendarioEmanuellaScreen() {
  ...
  const { events, loading, addEvent, updateEvent, deleteEvent } = useCalendarEvents('emanuella');
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Calendário Emanuella</Text>
