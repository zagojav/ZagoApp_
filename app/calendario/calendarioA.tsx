...
export default function CalendarioAmandaScreen() {
  ...
  useEffect(() => {
    carregar<Event[]>('calendario_amanda').then(dados => {
  ...
  useEffect(() => {
    salvar('calendario_amanda', events);
  }, [events]);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Calendário Amanda</Text>
        <View style={{ width: 40 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#6a0572' },
  backBtn: { width: 40, height: 40, borderRadius: 8, backgroundColor: '#e91e8c', justifyContent: 'center', alignItems: 'center' },
  ...
  monthSelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 15, backgroundColor: '#e91e8c', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12 },
  monthArrow: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  arrowText: { fontSize: 22, color: '#fff', fontWeight: 'bold' },
  monthYearContainer: { backgroundColor: '#6a0572', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  monthYearText: { fontSize: 14, fontWeight: '600', color: '#e91e8c' },
  weekDaysContainer: { flexDirection: 'row', marginBottom: 6 },
  weekDayCell: { flex: 1, paddingVertical: 8 },
  weekDayText: { textAlign: 'center', fontSize: 11, fontWeight: '700', color: '#6a0572' },
  ...
  todayDay: { backgroundColor: '#e91e8c', borderColor: '#e91e8c' },
  eventDay: { backgroundColor: '#FFFFFF', borderColor: '#e91e8c', borderWidth: 2 },
  dayNumber: { fontSize: 12, fontWeight: '600', color: '#6a0572' },
  dayNumberToday: { color: '#fff' },
  dayNumberEvent: { color: '#6a0572' },
  ...
  eventCard: { backgroundColor: '#F5F5F5', borderRadius: 12, padding: 12, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderLeftWidth: 3, borderLeftColor: '#e91e8c' },
  eventCardContent: { flex: 1, flexDirection: 'row', alignItems: 'flex-start' },
  eventDateBadge: { backgroundColor: '#e91e8c', width: 40, height: 40, borderRadius: 6, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  eventDateText: { fontSize: 14, fontWeight: '700', color: '#fff' },
  eventInfo: { flex: 1 },
  eventTitle: { fontSize: 14, fontWeight: '600', color: '#6a0572', marginBottom: 4 },
  eventTime: { fontSize: 12, color: '#e91e8c', marginBottom: 2 },
  ...
  dateDisplayValue: { fontSize: 14, fontWeight: '700', color: '#e91e8c' },
  ...
  confirmBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: '#e91e8c', alignItems: 'center' },
  ...
  monthPickerBtnActive: { backgroundColor: '#e91e8c' },
  ...
  yearPickerBtnActive: { backgroundColor: '#e91e8c' },
  yearPickerText: { fontSize: 13, fontWeight: '600', color: '#2a2a2a' },
  yearPickerTextActive: { color: '#fff' },
  pickerCloseBtn: { backgroundColor: '#e91e8c', paddingVertical: 12, borderRadius: 10, alignItems: 'center', marginTop: 16 },
