                  ...
                  {getActivitiesForDate(selectedDate).map(activity => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => toggleCompletion(activity, selectedDate, 'renata', 'Renata')}
                      >
...
const styles = StyleSheet.create({
  ...
  activityCheckbox: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: '#2e7d32', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  activityCheckboxDone: { backgroundColor: '#2e7d32' },
