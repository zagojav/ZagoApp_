...
const theme = CALENDAR_THEMES.renata;
...
export default function CalendarioRenataScreen() {
  ...
  const { events, loading, addEvent, updateEvent, deleteEvent } = useCalendarEvents('renata');
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Calendário Renata</Text>
