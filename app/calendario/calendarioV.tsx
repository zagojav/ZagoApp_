...
export default function CalendarioVanderScreen() {
  ...
  const myActivities = getActivitiesForPerson(activities, 'vander');

  // Carregar eventos ao abrir
  useEffect(() => {
    carregar<Event[]>('calendario_vander').then(dados => {
  ...
  useEffect(() => {
    salvar('calendario_vander', events);
  }, [events]);
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 15 }]}>
        ...
        <Text style={styles.headerTitle}>Calendário Vander</Text>
        <View style={{ width: 40 }} />
      </View>
                  ...
                  {getActivitiesForDate(selectedDate).map(activity => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => toggleCompletion(activity, selectedDate, 'vander', 'Vander')}
                      >
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#0d1b6e' },
  backBtn: { width: 40, height: 40, borderRadius: 8, backgroundColor: '#1a237e', justifyContent: 'center', alignItems: 'center' },
  ...
  monthSelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 15, backgroundColor: '#1a237e', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12 },
  monthArrow: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  arrowText: { fontSize: 22, color: '#fff', fontWeight: 'bold' },
  monthYearContainer: { backgroundColor: '#0d1b6e', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  monthYearText: { fontSize: 14, fontWeight: '600', color: '#1a237e' },
  weekDaysContainer: { flexDirection: 'row', marginBottom: 6 },
  weekDayCell: { flex: 1, paddingVertical: 8 },
  weekDayText: { textAlign: 'center', fontSize: 11, fontWeight: '700', color: '#0d1b6e' },
  ...
  todayDay: { backgroundColor: '#1a237e', borderColor: '#1a237e' },
  eventDay: { backgroundColor: '#FFFFFF', borderColor: '#1a237e', borderWidth: 2 },
  dayNumber: { fontSize: 12, fontWeight: '600', color: '#0d1b6e' },
  dayNumberToday: { color: '#fff' },
  dayNumberEvent: { color: '#0d1b6e' },
  eventIndicators: { flexDirection: 'row', marginTop: 2, alignItems: 'center' },
  eventDot: { width: 3, height: 3, borderRadius: 1.5, backgroundColor: '#1a237e' },
  moreIndicator: { fontSize: 8, color: '#1a237e', fontWeight: 'bold', marginLeft: 2 },
  ...
  activityCheckbox: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: '#1a237e', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  activityCheckboxDone: { backgroundColor: '#1a237e' },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '700', color: '#0d1b6e', marginBottom: 12 },
  emptyEventsText: { fontSize: 14, color: '#666', fontStyle: 'italic', textAlign: 'center', paddingVertical: 20 },
  eventCard: { backgroundColor: '#F5F5F5', borderRadius: 12, padding: 12, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderLeftWidth: 3, borderLeftColor: '#1a237e' },
  eventCardContent: { flex: 1, flexDirection: 'row', alignItems: 'flex-start' },
  eventDateBadge: { backgroundColor: '#1a237e', width: 40, height: 40, borderRadius: 6, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  eventDateText: { fontSize: 14, fontWeight: '700', color: '#fff' },
  eventInfo: { flex: 1 },
  eventTitle: { fontSize: 14, fontWeight: '600', color: '#0d1b6e', marginBottom: 4 },
  eventTime: { fontSize: 12, color: '#1a237e', marginBottom: 2 },
  ...
  dateDisplayValue: { fontSize: 14, fontWeight: '700', color: '#1a237e' },
  ...
  confirmBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: '#1a237e', alignItems: 'center' },
  ...
  monthPickerBtnActive: { backgroundColor: '#1a237e' },
  ...
  yearPickerBtnActive: { backgroundColor: '#1a237e' },
  yearPickerText: { fontSize: 13, fontWeight: '600', color: '#2a2a2a' },
  yearPickerTextActive: { color: '#fff' },
  pickerCloseBtn: { backgroundColor: '#1a237e', paddingVertical: 12, borderRadius: 10, alignItems: 'center', marginTop: 16 },
