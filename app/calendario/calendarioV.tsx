...
const theme = CALENDAR_THEMES.vander;
...
export default function CalendarioVanderScreen() {
  ...
  const { events, loading, addEvent, updateEvent, deleteEvent } = useCalendarEvents('vander');
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Calendário Vander</Text>
