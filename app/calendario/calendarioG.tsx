...
const theme = CALENDAR_THEMES.guilherme;
...
export default function CalendarioGuilhermeScreen() {
  ...
  const { events, loading, addEvent, updateEvent, deleteEvent } = useCalendarEvents('guilherme');
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Calendário Guilherme</Text>
