...
const theme = CALENDAR_THEMES.lucas;
...
export default function CalendarioLucasScreen() {
  ...
  const { events, loading, addEvent, updateEvent, deleteEvent } = useCalendarEvents('lucas');
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Calendário Lucas</Text>
