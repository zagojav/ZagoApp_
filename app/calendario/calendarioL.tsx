...
export default function CalendarioLucasScreen() {
  ...
  const myActivities = getActivitiesForPerson(activities, 'lucas');

  // Carregar eventos ao abrir
  useEffect(() => {
    carregar<Event[]>('calendario_lucas').then(dados => {
  ...
  useEffect(() => {
    salvar('calendario_lucas', events);
  }, [events]);
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 15 }]}>
        ...
        <Text style={styles.headerTitle}>Calendário Lucas</Text>
        <View style={{ width: 40 }} />
      </View>
                  ...
                  {getActivitiesForDate(selectedDate).map(activity => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => toggleCompletion(activity, selectedDate, 'lucas', 'Lucas')}
                      >
...
const styles = StyleSheet.create({
  ...
  backBtn: { width: 40, height: 40, borderRadius: 8, backgroundColor: '#424242', justifyContent: 'center', alignItems: 'center' },
  ...
  monthSelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 15, backgroundColor: '#000000', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12 },
  monthArrow: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  arrowText: { fontSize: 22, color: '#fff', fontWeight: 'bold' },
  monthYearContainer: { backgroundColor: '#424242', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  monthYearText: { fontSize: 14, fontWeight: '600', color: '#FFFFFF' },
  ...
  todayDay: { backgroundColor: '#000000', borderColor: '#000000' },
  eventDay: { backgroundColor: '#FFFFFF', borderColor: '#000000', borderWidth: 2 },
  ...
  eventDot: { width: 3, height: 3, borderRadius: 1.5, backgroundColor: '#000000' },
  moreIndicator: { fontSize: 8, color: '#000000', fontWeight: 'bold', marginLeft: 2 },
  ...
  activityCheckbox: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: '#000000', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  activityCheckboxDone: { backgroundColor: '#000000' },
  ...
  eventCard: { backgroundColor: '#F5F5F5', borderRadius: 12, padding: 12, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderLeftWidth: 3, borderLeftColor: '#000000' },
  eventCardContent: { flex: 1, flexDirection: 'row', alignItems: 'flex-start' },
  eventDateBadge: { backgroundColor: '#000000', width: 40, height: 40, borderRadius: 6, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  eventDateText: { fontSize: 14, fontWeight: '700', color: '#fff' },
  eventInfo: { flex: 1 },
  eventTitle: { fontSize: 14, fontWeight: '600', color: '#000000', marginBottom: 4 },
  eventTime: { fontSize: 12, color: '#424242', marginBottom: 2 },
  ...
  dateDisplayValue: { fontSize: 14, fontWeight: '700', color: '#000000' },
  ...
  confirmBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: '#000000', alignItems: 'center' },
  ...
  monthPickerBtnActive: { backgroundColor: '#000000' },
  ...
  yearPickerBtnActive: { backgroundColor: '#000000' },
  yearPickerText: { fontSize: 13, fontWeight: '600', color: '#2a2a2a' },
  yearPickerTextActive: { color: '#fff' },
  pickerCloseBtn: { backgroundColor: '#000000', paddingVertical: 12, borderRadius: 10, alignItems: 'center', marginTop: 16 },
